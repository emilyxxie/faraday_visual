...
function Filing(x, y, i) {
  ...
  this.opacityVarianceMultiplier = random(0.9, 2.5)
  ...
  */
  this.calculateIntensity = function() {
    ...
    var intensity = (MAGNETIC_MOMENT * Math.sqrt(3 * Math.pow(Math.cos(theta), 2) + 1)) / Math.pow(hypoteneuse, 3);
    this.intensity = map(intensity, 0, 50, 0, MAXIMUM_FILING_OPACITY) * intensityMultiplier;
  }
